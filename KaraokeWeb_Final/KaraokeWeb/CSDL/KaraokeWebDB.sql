...
INSERT INTO orders (OrderDate, MaPhong, TotalFoodAmount, IsPaid) VALUES 
    ('2025-05-27 09:00:00', 'VIP34_1', 300000, 1),  
    ('2025-05-27 10:30:00', 'VIP34_2', 150000, 0), 
    ('2025-05-27 14:15:00', 'VIP34_3', 500000, 1), 
    ('2025-05-27 16:45:00', 'VIP34_4', 250000, 0),  
    ('2025-04-26 08:20:00', 'VIP34_5', 450000, 1); 

INSERT INTO ordersDetail (OrderId, MaMon, Quantity, UnitPrice) VALUES 
    (1, 'MON001', 2, 50000),
    (1, 'MON002', 1, 200000),
    (2, 'MON003', 3, 50000),
    (3, 'MON001', 5, 60000),
...
INSERT INTO ElectricityBillRecords (MaBillElec, Ngay, SoTien) VALUES 
('ELEC1224', '2024-12-01', 1500000),
('ELEC0125', '2025-01-01', 1650000),
('ELEC0225', '2025-02-01', 1580000),
('ELEC0325', '2025-03-01', 1720000),
('ELEC0425', '2025-04-01', 1630000),
('ELEC0525', '2025-05-01', 1850000);

INSERT INTO WaterBillRecords(MaBillWater, Ngay, SoTien) VALUES 
('WATR1224', '2024-12-01', 600000),
('WATR0125', '2025-01-01', 580000),
('WATR0225', '2025-02-01', 620000),
('WATR0325', '2025-03-01', 610000),
('WATR0425', '2025-04-01', 730000),
('WATR0525', '2025-05-01', 850000);

INSERT INTO Staffs (MaNhanVien, Ten, SDT_NhanVien, Email, Luong) VALUES
('NV001', N'Nguyễn Ngọc Huy', '0865686165', 'emmotinnhan15@gmail.com', 10000000),
('NV002', N'Trịnh Trần Phương Tuấn', '0923456789', 'dung@example.com', 5000000),
('NV003', N'Đặng Tiến Hoàng', '0934567890', 'hoa@example.com', 500000);
